...
class ConfirmRoutePage extends StatefulWidget {
   const ConfirmRoutePage({Key? key}) : super(key: key);
  @override
  State<ConfirmRoutePage> createState() => _ConfirmRoutePageState();
}

class _ConfirmRoutePageState extends State<ConfirmRoutePage> {
                ...
                Row(
                 ...
                 const SizedBox(height: 10,),
                  ...
                  const SizedBox(height: 20,),
                   ...
                   const Center(
                    child: Text("Talk about your offerings",style: TextStyle(color: secondaryColor,fontFamily: "SegoeUI",fontWeight: FontWeight.bold,fontSize: 20),),
                  ),
                  const SizedBox(height: 10,),
                  Padding(
                ...
                child: ElevatedButton(
                  style: ButtonStyle(
                    backgroundColor: MaterialStateProperty.resolveWith<Color>(
                        ...
                        if (states.contains(MaterialState.disabled)) {
                          return _isChecked! ? secondaryColor : Colors.grey; // set the button color when disabled
                        }
                        return _isChecked! ? secondaryColor : Colors.grey; // set the button color in other states
                      },
                    ),
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const ConfirmationPage(index: 1,),
                        ));

                  },
                  child: const Text('Publish',style: TextStyle(color: Colors.white,fontFamily: "SegoeUI",fontWeight: FontWeight.bold,fontSize: 18),),
                ),
              ),
            ),
            const SizedBox(height: 20,),
