...
class DriverOngoingRoutePage extends StatefulWidget {
  const DriverOngoingRoutePage({Key? key}) : super(key: key);

  @override
  State<DriverOngoingRoutePage> createState() => _DriverOngoingRoutePageState();
}

class _DriverOngoingRoutePageState extends State<DriverOngoingRoutePage> {
  @override
            ...
            onTap: (){
              if(index==0) {
                Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          const PassengerProfileRequest(color: secondaryColor, index: 0,),
                    ));
              }else{
                Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) =>
                          PassengerProfileRequest(color: secondaryColor, index: index,),
                    ));
              }
            },
